...
public class ExpandableListAdapter extends BaseExpandableListAdapter {    private Context context;
    ...
    public View getChildView(int i, int il, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView ListChild = (TextView) view.findViewById(R.id.list_itemm);
